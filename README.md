<br />
<p align="center">
  <a href="https://github.com/aleksandar1202/next-e-commerce-website">
  ...
  <p align="center">
    An e-commerce website example built with Next.js that made it as a self challenge. There are some issues that I will handle later. Using Firebase as backend.
    <br />
  </p>
</p>
...
I saw a UI design on Dribbble by [Anton Mikhaltsov](https://dribbble.com/shots/9404340-Shop-Clothing-Web-Page). And I wanted to code this design. So I decided to make it a full working website with NextJS but as challenge myself. Some issues are still there but I will check out them later.
...
```sh
git clone https://github.com/aleksandar1202/next-e-commerce-website.git
cd next-e-commerce-website
```
